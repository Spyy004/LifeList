...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: Consumer<BucketListService>(
                            ...
                            showModalBottomSheet(
                              ...
                              builder: (BuildContext context) {
                                return Consumer2<FilterService,
                                    BucketListService>(
                                  builder: (context, filterModel, bucket2model,
                                          child) =>
                                      SizedBox(
                                    height: Sizes.screenHeight(context) * 0.9,
                  ...
                  bucketModel.filteredBuckets.isNotEmpty
                      ? SliverGrid(
                          ...
                          delegate: SliverChildBuilderDelegate(
                              childCount: bucketModel.filteredBuckets.length,
